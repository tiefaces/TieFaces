...
public class ValidationHandlerTest {
	...
	/**
	 * Test method for {@link org.tiefaces.components.websheet.service.ValidationHandler#validateWithRowColInCurrentPage(int, int, boolean)}.
	 */
	@Test	
	public final void testValidateWithRowColInCurrentPage()
		...
		Throwable e = null;
		try {
			bean.getValidationHandler().validateWithRowColInCurrentPage(4, 3, true);
		 } catch (Throwable ex) {
		   e = ex;
		}
	...
	/**
	 * Test method for {@link org.tiefaces.components.websheet.service.ValidationHandler#validateRowInCurrentPage(int, boolean)}.
	 */
	@Test
	public final void testValidateRowInCurrentPage() throws Exception {
		...
		assertFalse(bean.getValidationHandler().validateRowInCurrentPage(4, true));
		
		
	}

	/**
	 * Test method for {@link org.tiefaces.components.websheet.service.ValidationHandler#findFirstInvalidSheet(boolean)}.
	 */
	@Test
	public final void testFindFirstInvalidSheet() throws Exception {
		...
		assertEquals(bean.loadWebSheet(stream,context), 1);				
		bean.getCellsMap().put("4:3","-1");
		assertEquals(bean.getValidationHandler().findFirstInvalidSheet(true),"Sale Price Report");
