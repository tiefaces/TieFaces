...
public final class ConfigurationUtility {
     ...
     * @param actionType
     *            the action Type ( 1: add, -1: delete).
     *            
     */
    public static void reBuildUpperLevelFormula(
            final ConfigBuildRef configBuildRef,
            final String actionFullName, final int actionType) {
        ...
        for (Map.Entry<Cell, String> entry : cachedMap.entrySet()) {
            ...
            if (originFormula != null) {
                setupUpperLevelFormula(cell, originFormula, actionFullName,
                        rowsMap, configBuildRef, actionType);
            }
        }
    ...
    private static void setupUpperLevelFormula(Cell cell,
            String originFormula, final String actionFullName,
            Map<String, List<RowsMapping>> rowsMap,
            final ConfigBuildRef configBuildRef, final int actionType) {  
