...
public final class FacesUtility {
	...
	public static InputStream getResourceAsStream(FacesContext context,
			String path) {
	...
	public static <T> T evaluateExpression(String expression,
			Class<? extends T> expected) {
		return evaluateExpression(FacesContext.getCurrentInstance(),
				expression, expected);
	}

	public static <T> T evaluateExpression(FacesContext context,
			String expression, Class<? extends T> expected) {
